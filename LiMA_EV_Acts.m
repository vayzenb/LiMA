...
for ee = 1:length(exp)
	...
	for sk = 1:length(skel{ee})
		for sf = 1:length(SF)
			...
			save(['Activations/EV_Acts/Figure_', skel{ee}{sk},'_',SF{sf}, '_GBJ_Acts_Size', int2str(imScale*100)], 'sizeActs_GBJ');
            
            save(['Activations/EV_Acts/Figure_', skel{ee}{sk},'_',SF{sf}, '_GIST_Acts'], 'stimActs_GIST');
			save(['Activations/EV_Acts/Figure_', skel{ee}{sk},'_',SF{sf}, '_GIST_Acts_Size', int2str(imScale*100)], 'sizeActs_GIST');
